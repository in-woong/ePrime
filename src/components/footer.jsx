  ...
  return (
    <footer className='footer min-w-[1300px] w-full p-10 grid grid-cols-3 bg-gray-100 text-gray-800 dark:text-gray-100 dark:bg-gray-900 footer-center '>
      <div>
        ...
        <div>새로운 식문화를 창조해 가는 글로벌 리더 매일유업</div>
        <div>매일유업 오시는 길</div>
      </div>
      <div className=''>
        <div className='mb-6'>Featured News</div>
        <div>
          <div></div>
          <div className='max-w-md'>
            <span>MIC 멈춤없는 새로움에 대한 도전</span>
            <span>
              우리는 민감한 매일, 맛있는 매일, 새로운 매일을 연구하고 개척합니다{' '}
            </span>
          </div>
        </div>
      </div>
      <div>
        <div className='mb-6'>SNS</div>
